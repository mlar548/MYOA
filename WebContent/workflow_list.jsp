                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="dep" items="${depList}">
	                    <tr>
	                        ...
	                        <td>
	                            <a href="delDeployment?deploymentId=${dep.id}" onclick="javascript:return del()" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
