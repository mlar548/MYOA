...
<script type="text/javascript">
	function changeImage(){
	    var pic = document.getElementById('identity');
	    var ts = Math.random();
	    pic.src="${pageContext.request.contextPath}/verification?ts=" + ts;
	}
</script>
</head>
<body>
					...
					<div class="form-group">
						<div class="col-sm-6">
							<input type="text" name="verificationcode" class="form-control"
								id="verificationcode" placeholder="请输入验证码"> <i
								class="fa fa-lock"></i> <a href="#"
								class="fa fa-question-circle"></a>
						</div>
						<img src="${pageContext.request.contextPath}/verification" alt="点击换一张" id="identity" onclick="changeImage()"/>
				        <!-- <input class="layui-btn layui-btn-checked" type="button" onclick="changeImage()" value="换一张"> -->
				        <span style="color: #ff0000;">${codemessage}</span>
					</div>
					<div class="form-group">
